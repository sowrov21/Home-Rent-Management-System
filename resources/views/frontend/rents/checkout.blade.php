@extends('frontend.layouts.master') @section('content') {{-- @dd(session('cart')) --}}
<section class="content-wrap">
    <div class="container">

        <div class="row">
            <div class="col-6">
                <h4 class="text-center">Choosed Apartment</h4>
                <div class="row">
                    <table class="table table-borderless">
                        ...
                        @php $total =0; $sl=1;@endphp
                        <tbody>
                            @if (session('cart')) @foreach (session('cart') as $id =>$apartment) @php $total +=$apartment['price']; @endphp
                            <tr>
                                <td>{{$sl++}}</td>
                    ...
                    <div class="card-body">
                      ...
                      <form>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" value="01866106809" class="form-control" id="phone">
                        </div>
                        <div class="mb-3">
                          <label for="payment" class="form-label">Payment Method</label>
                         <select name="" id="" class="form-control">
                             <option value=""  style="display: none">Choose Method</option>
                        ...
                        <div class="text-right">
                            <a class="btn btn-success" href="{{route('rent.checkout')}}">Confirm Order</a>
                        </div>
                      </form>
                    </div>
                  </div>
...
@endpush @push('custom-scripts') @endpush
