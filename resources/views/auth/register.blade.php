...
<html lang="en">
	...
	<body id="kt_body" class="bg-body">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
							...
							<img alt="Logo" src="{{asset('backend/dist')}}/assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Sign in with Google</button>
							<!--end::Action-->
							<!--begin::Separator-->
		...
		<script src="{{asset('backend/dist')}}/assets/js/custom/authentication/sign-up/general.js"></script>
