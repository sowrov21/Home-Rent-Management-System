...
<html lang="en">
	...
	<body id="kt_body" class="bg-body">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{asset('backend/dist')}}/assets/media/illustrations/sketchy-1/14.png">
				<!--begin::Content-->
                    ...
                    <x-auth-validation-errors class="mb-4" :errors="$errors" />
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="{{route('login') }}" method="POST" action="{{ route('login') }}">
							...
							<div class="text-center">
								...
								<img alt="Logo" src="{{asset('backend/dist')}}/assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Continue with Google</a>
								<!--end::Google link-->
								<!--begin::Google link-->
								<a href="{{ url('auth/facebook') }}" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
								<img alt="Logo" src="{{asset('backend/dist')}}/assets/media/svg/brand-logos/facebook-4.svg" class="h-20px me-3" />Continue with Facebook</a>
								<!--end::Google link-->
								<!--begin::Google link-->
								<a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100">
								<img alt="Logo" src="{{asset('backend/dist')}}/assets/media/svg/brand-logos/apple-black.svg" class="h-20px me-3" />Continue with Apple</a>
								<!--end::Google link-->
							</div>
							<!--end::Actions-->
						</form>
		...
		<script src="{{asset('backend/dist')}}/assets/js/custom/authentication/sign-in/general.js"></script>
