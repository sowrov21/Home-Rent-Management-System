								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div class="menu-inner flex-column collapse show" id="kt_aside_menu_collapse">
											...
											<div class="menu-item">
												<a class="menu-link active" href="../../demo1/dist/dashboards/crypto.html">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div class="menu-inner flex-column collapse show" id="kt_aside_menu_collapse_2">
														...
														<div class="menu-item">
															<a class="menu-link active py-3" href="../../demo1/dist/dashboards/crypto.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Crypto</span>
						...
						<div class="toolbar bg-transparent pt-6 mb-5" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 flex-column mb-0">My Balance: 37,045$
									<!--begin::Description-->
									<span class="text-muted fs-7 fw-bold mt-2">You’ve got
									<a href="../demo1/apps/ecommerce/sales/listing.html" class="link-primary fw-bolder">24 New</a>&#160;Product Sales</span>
									<!--end::Description--></h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<a href="../../demo1/dist/.html" class="btn btn-sm btn-white btn-active-white btn-active-color-primary">Manage Stock</a>
									<!--end::Secondary button-->
									<!--begin::Primary button-->
									<a href="../../demo1/dist/.html" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_top_up_wallet">Add Product</a>
									<!--end::Primary button-->
								</div>
								<!--end::Actions-->
							</div>
											...
											<div class="card-body">
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center me-5">
														...
														<div class="me-5">
															<!--begin::Title-->
															<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">GPUs mining</a>
															<!--end::Title-->
															<!--begin::Desc-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center me-5">
														...
														<div class="me-5">
															<!--begin::Title-->
															<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Est. daily USD</a>
															<!--end::Title-->
															<!--begin::Desc-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center me-5">
														...
														<div class="me-5">
															<!--begin::Title-->
															<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Team Members</a>
															<!--end::Title-->
															<!--begin::Desc-->
							...
							<form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate" id="kt_modal_top_up_wallet_stepper_form">
								...
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-15">
											<!--begin::Title-->
											<h2 class="fw-bolder d-flex align-items-center text-dark">Set Amount to Top Up
										...
										<div class="mb-10">
											<!--begin::Label-->
											<label class="required fw-bold fs-6 mb-5">Currency Type</label>
											<!--end::Label-->
											<!--begin::Row-->
											<div class="row row-cols-1 row-cols-md-2 g-5">
												...
												<div class="col">
													...
													<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex align-items-center h-100" for="kt_radio_buttons_2_option_1">
														...
														<span class="d-block fw-bold text-start">
															<span class="text-dark fw-bolder d-block fs-3">Cash</span>
															<span class="text-muted fw-bold fs-6">Top up wallet using cash from one of your saved payment options.</span>
														</span>
													</label>
													<!--end::Option-->
												</div>
												...
												<div class="col">
													...
													<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex align-items-center h-100" for="kt_radio_buttons_2_option_2">
														<!--begin::Svg Icon | path: icons/duotune/finance/fin009.svg-->
														<span class="svg-icon svg-icon-3hx svg-icon-primary">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<path opacity="0.3" d="M15.8 11.4H6C5.4 11.4 5 11 5 10.4C5 9.80002 5.4 9.40002 6 9.40002H15.8C16.4 9.40002 16.8 9.80002 16.8 10.4C16.8 11 16.3 11.4 15.8 11.4ZM15.7 13.7999C15.7 13.1999 15.3 12.7999 14.7 12.7999H6C5.4 12.7999 5 13.1999 5 13.7999C5 14.3999 5.4 14.7999 6 14.7999H14.8C15.3 14.7999 15.7 14.2999 15.7 13.7999Z" fill="currentColor" />
														...
														<!--end::Svg Icon-->
														<span class="d-block fw-bold text-start">
															<span class="text-dark fw-bolder d-block fs-3">Crypto</span>
															<span class="text-muted fw-bold fs-6">Top up wallet using a crypto currency.</span>
														</span>
													</label>
													<!--end::Option-->
												</div>
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-12">
											<!--begin::Title-->
											<h1 class="fw-bolder text-dark">Currency</h1>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="text-muted fw-bold fs-6">If you need more info, please check
										...
										<div class="" data-kt-modal-top-up-wallet-option="dollar">
											...
											<div class="fv-row mb-10">
												<!--begin::Label-->
												<label class="required fs-6 fw-bold mb-2">Select a payment method</label>
												<!--End::Label-->
												<!--begin::Row-->
												<div class="row row-cols-1 row-cols-md-2 g-5">
													<!--begin::Col-->
													<div class="col">
														...
														<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex align-items-start gap-5 h-100" for="kt_modal_top_up_wallet_payment_method_option_0">
															<!--begin::Icon-->
															...
															<div class="d-flex align-items-start flex-column gap-3">
																...
																<!--begin::Card number-->
																<div class="text-dark fw-bolder">**** 8742</div>
																<!--end::Card number-->
																<!--begin::Card expiry-->
													...
													<div class="col">
														...
														<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex align-items-start gap-5 h-100" for="kt_modal_top_up_wallet_payment_method_option_1">
															<!--begin::Icon-->
															...
															<div class="d-flex align-items-start flex-column gap-3">
																...
																<!--begin::Card number-->
																<div class="text-dark fw-bolder">**** 1141</div>
																<!--end::Card number-->
																<!--begin::Card expiry-->
													...
													<div class="col">
														...
														<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex align-items-start gap-5 h-100" for="kt_modal_top_up_wallet_payment_method_option_2">
															<!--begin::Icon-->
															<img src="assets/media/svg/card-logos/mastercard.svg" alt="" class="w-50px" />
															<!--end::Icon-->
															<!--begin::Card details-->
															<div class="d-flex align-items-start flex-column gap-3">
																...
																<!--begin::Card number-->
																<div class="text-dark fw-bolder">**** 8839</div>
																<!--end::Card number-->
																<!--begin::Card expiry-->
													...
													<div class="col">
														<!--begin::Add new card-->
														<a href="../../demo1/dist/utilities/modals/forms/new-card.html" class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex flex-column flex-center gap-5 h-100">
															<!--begin::Icon-->
															...
															<!--end::Icon-->
															<!--begin::Label-->
															<div class="fs-5 fw-bolder">Add New Card</div>
															<!--end::Label-->
														</a>
														<!--end::Add new card-->
													</div>
										...
										<div class="d-none" data-kt-modal-top-up-wallet-option="crypto">
											...
											<div class="mb-10">
												<!--begin::Label-->
												<label class="required fs-6 fw-bold mb-2">Select a coin</label>
												<!--End::Label-->
												<!--begin::Row-->
												<div class="row row-cols-2 row-cols-md-4 g-5">
													...
													<div class="col">
														...
														<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_0">
															<!--begin::Icon-->
															<img src="assets/media/svg/coins/binance.svg" alt="" class="w-50px" />
															<!--end::Icon-->
															<!--begin::Label-->
															<div class="fs-5 fw-bolder">Binance</div>
															<!--end::Label-->
														</label>
													</div>
													<!--end::Col-->
													...
													<div class="col">
														...
														<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_1">
															<!--begin::Icon-->
															<img src="assets/media/svg/coins/bitcoin.svg" alt="" class="w-50px" />
															<!--end::Icon-->
															<!--begin::Label-->
															<div class="fs-5 fw-bolder">Bitcoin</div>
															<!--end::Label-->
														</label>
													</div>
													<!--end::Col-->
													...
													<div class="col">
														...
														<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_2">
															<!--begin::Icon-->
															<img src="assets/media/svg/coins/chainlink.svg" alt="" class="w-50px" />
															<!--end::Icon-->
															<!--begin::Label-->
															<div class="fs-5 fw-bolder">Chainlink</div>
															<!--end::Label-->
														</label>
													</div>
													<!--end::Col-->
													...
													<div class="col">
														...
														<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_3">
															<!--begin::Icon-->
															<img src="assets/media/svg/coins/coin.svg" alt="" class="w-50px" />
															<!--end::Icon-->
															<!--begin::Label-->
															<div class="fs-5 fw-bolder">Coin</div>
															<!--end::Label-->
														</label>
													</div>
													<!--end::Col-->
													...
													<div class="col">
														...
														<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_4">
															<!--begin::Icon-->
															<img src="assets/media/svg/coins/ethereum.svg" alt="" class="w-50px" />
															<!--end::Icon-->
															<!--begin::Label-->
															<div class="fs-5 fw-bolder">Ethereum</div>
															<!--end::Label-->
														</label>
													</div>
													<!--end::Col-->
													...
													<div class="col">
														...
														<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_5">
															<!--begin::Icon-->
															<img src="assets/media/svg/coins/filecoin.svg" alt="" class="w-50px" />
															<!--end::Icon-->
															<!--begin::Label-->
															<div class="fs-5 fw-bolder">Filecoin</div>
															<!--end::Label-->
														</label>
													</div>
													<!--end::Col-->
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-12">
											<!--begin::Title-->
											<h1 class="fw-bolder text-dark">Authentication</h1>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="text-muted fw-bold fs-6">If you need more info, please check
											<a href="#" class="link-primary">Top Up Guidelines</a></div>
										...
										<div class="d-flex flex-column mb-10">
											<!--begin::Label-->
											<label class="fs-6 fw-bold mb-2">Secret Key
											<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Please ensure that your secret key matches your saved image and keyword"></i></label>
											<!--end::Label-->
											<div class="d-flex align-items-center gap-5">
												...
												<!--end::Image-->
												<!--begin::Keyword-->
												<div class="fw-bolder fs-5">my_secret_key</div>
												<!--end::Keyword-->
											</div>
										</div>
										<!--end::Secret key-->
										...
										<div class="fv-row mb-10">
											<!--begin::Label-->
											<label class="fs-6 fw-bold mb-2">Enter Password
											<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Please enter your password to authenticate the wallet top up"></i></label>
											<!--End::Label-->
											<!--begin::Input-->
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-12 text-center">
											<!--begin::Title-->
											<h1 class="fw-bolder text-dark">Successful Top Up!</h1>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="fw-bold text-muted fs-4">You will receive an email with with the summary of your latest top up!</div>
											<!--end::Description-->
										</div>
										<!--end::Heading-->
										<!--begin::Actions-->
