								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div class="menu-inner flex-column collapse show" id="kt_aside_menu_collapse">
											...
											<div class="menu-item">
												<a class="menu-link active" href="../../demo1/dist/dashboards/store-analytics.html">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div class="menu-inner flex-column collapse show" id="kt_aside_menu_collapse_2">
														...
														<div class="menu-item">
															<a class="menu-link active py-3" href="../../demo1/dist/dashboards/store-analytics.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Store Analytics</span>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Store Analytics</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
								<!--begin::Actions-->
													...
													<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 my-0">
														...
														<tbody>
															<tr>
																...
																<td class="ps-0">
																	<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
															...
															<tr>
																...
																<td class="ps-0">
																	<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
																	<span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
																</td>
																<td>
															...
															<tr>
																...
																<td class="ps-0">
																	<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
																	<span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
																</td>
																<td>
															...
															<tr>
																...
																<td class="ps-0">
																	<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Yellow Stone</a>
																	<span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
																</td>
																<td>
																	<span class="text-gray-800 fw-bolder d-block fs-6 ps-0 text-end">$72.00</span>
												...
												<div class="mb-0">
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center me-5">
															...
															<div class="me-5">
																<!--begin::Title-->
																<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Search Retargeting</a>
																<!--end::Title-->
																<!--begin::Desc-->
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center me-5">
															...
															<div class="me-5">
																<!--begin::Title-->
																<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Social Retargeting</a>
																<!--end::Title-->
																<!--begin::Desc-->
																<span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Direct link clicks</span>
																<!--end::Desc-->
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center me-5">
															...
															<div class="me-5">
																<!--begin::Title-->
																<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Email Retargeting</a>
																<!--end::Title-->
																<!--begin::Desc-->
																<span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Direct link clicks</span>
																<!--end::Desc-->
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center me-5">
															...
															<div class="me-5">
																<!--begin::Title-->
																<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Referrals Customers</a>
																<!--end::Title-->
																<!--begin::Desc-->
																<span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Direct link clicks</span>
																<!--end::Desc-->
											...
											<div class="card-body card-body d-flex justify-content-between flex-column pt-3">
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
														...
														<div class="me-5">
															<!--begin::Title-->
															<a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Facebook</a>
															<!--end::Title-->
															<!--begin::Desc-->
															<span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Social Network</span>
															<!--end::Desc-->
											...
											<div class="card-body d-flex align-items-end">
												...
												<div class="w-100">
													...
													<div class="text-center pt-8 d-1">
														<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-primary opacity-75-hover fs-6 fw-bolder">View Store Analytics
														<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
