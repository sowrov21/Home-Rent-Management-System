								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div class="menu-inner flex-column collapse show" id="kt_aside_menu_collapse">
											...
											<div class="menu-item">
												<a class="menu-link active" href="../../demo1/dist/dashboards/podcast.html">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div class="menu-inner flex-column collapse show" id="kt_aside_menu_collapse_2">
														...
														<div class="menu-item">
															<a class="menu-link active py-3" href="../../demo1/dist/dashboards/podcast.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Podcast</span>
						...
						<div class="toolbar bg-transparent pt-6 mb-5" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 flex-column mb-0">Podcast Dashboard
									<!--begin::Description-->
										...
										<div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color:#020202;background-image:url('assets/media/stock/600x600/img-62.jpg')">
											...
											<div class="card-body d-flex justify-content-between flex-column ps-xl-18">
												...
												<div class="mb-xl-10 mb-3">
													...
													<a href="../../demo1/dist/apps/support-center/overview.html" class="btn btn-color-white bg-transparent btn-outline fw-bold" style="border: 1px solid rgba(255, 255, 255, 0.3)">Save for Later</a>
												</div>
												<!--begin::Action-->
											</div>
											<!--end::Body-->
											...
											<div class="card-body pt-6">
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														...
														<div class="flex-grow-1 me-2">
															<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-5 fw-boldest">Leslie Alexander</a>
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-5 fw-boldest">Jacob Jones</a>
															<span class="text-gray-400 fw-bold d-block fs-6">Community</span>
														</div>
														<!--end:Author-->
														<!--begin::Follow-->
														<button class="btn btn-sm btn-primary py-2 px-4 fs-7 fw-bolder" data-kt-element="follow">Following</button>
														<!--end::Follow-->
													</div>
													<!--end::Section-->
												</div>
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-5 fw-boldest">Ronald Richards</a>
															<span class="text-gray-400 fw-bold d-block fs-6">Community</span>
														</div>
														<!--end:Author-->
														<!--begin::Follow-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-5 fw-boldest">Courtney Henry</a>
															<span class="text-gray-400 fw-bold d-block fs-6">Community</span>
														</div>
														<!--end:Author-->
														<!--begin::Follow-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-5 fw-boldest">Arlene McCoy</a>
															<span class="text-gray-400 fw-bold d-block fs-6">Community</span>
														</div>
														<!--end:Author-->
														<!--begin::Follow-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-5 fw-boldest">Marvin McKinney</a>
															<span class="text-gray-400 fw-bold d-block fs-6">Community</span>
														</div>
														<!--end:Author-->
														<!--begin::Follow-->
											...
											<div class="card-body pt-7">
												...
												<div class="row align-items-end h-100 gx-5 gx-xl-10">
													...
													<div class="col-md-4 mb-11 mb-md-0">
														...
														<div class="m-0">
															<!--begin::Title-->
															<a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Feeling Good</a>
															<!--end::Title-->
															<!--begin::Time-->
													...
													<div class="col-md-4 mb-11 mb-md-0">
														...
														<div class="m-0">
															<!--begin::Title-->
															<a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Both Sides</a>
															<!--end::Title-->
															<!--begin::Time-->
													...
													<div class="col-md-4">
														...
														<div class="m-0">
															<!--begin::Title-->
															<a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Birds in the Sky</a>
															<!--end::Title-->
															<!--begin::Time-->
										...
										<div class="card h-md-100">
											...
											<div class="card-body d-flex flex-column flex-center">
												...
												<div class="mb-2">
													...
													<!--end::Title-->
													<!--begin::Illustration-->
													<div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-125px mh-200px my-5 my-lg-12" style="background-image:url('assets/media/svg/illustrations/easy/2.svg')"></div>
													<!--end::Illustration-->
												</div>
												<!--end::Heading-->
												<!--begin::Links-->
														...
														<div class="table-responsive mx-9 mt-n6">
															...
															<table class="table align-middle gs-0 gy-4">
																...
																<tbody>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 fw-bolder fs-6">Podcasts</a>
																		</td>
																		<td class="pe-0 text-end">
