			...
			<tr>
				<td align="left" valign="center">
					<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
						...
						<div style="padding-bottom: 30px">You have been invited to join the Keenthemes team from
						<a href="support@keenthemes.com" rel="noopener" target="_blank" style="text-decoration:none;color: #009EF7">support@keenthemes.com</a>. To get started, accept the invite below:</div>
						...
						<a href="https://keenthemes.com/support" rel="noopener" target="_blank" style="text-decoration:none;color: #009EF7">https://keenthemes.com/support</a>.</div>
						<!--end:Email content-->
